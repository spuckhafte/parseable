...
use crate::{
    doc_create_correlation, doc_delete_correlation, doc_get_correlation_by_id,
    doc_list_correlations, doc_modify_correlation,
};

doc_list_correlations! {
    /// List correlations
    ///
